...
from cliport import dataset1
from cliport import tasks
from cliport.utils import utils
from cliport.environments.environment import Environment


@hydra.main(config_path='./cfg', config_name='eval1')
def main(vcfg):
    # Load train cfg
    ...
    if 'multi' in dataset_type:
        ds = dataset1.RavensMultiTaskDataset(vcfg['data_dir'],
                                            tcfg,
                                            group=eval_task,
                                            mode=mode,
        ...
        ds = dataset1.RavensDataset(os.path.join(vcfg['data_dir'], f"{eval_task}-2-{mode}"),
                                   tcfg,
                                   n_demos=vcfg['n_demos'],
                                   augment=False)
