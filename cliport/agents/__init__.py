...
from cliport.agents.transporter_lang_goal import TwoStreamClipLingUNetLatTransporterAgent_two
from cliport.agents.transporter_lang_goal import TwoStreamClipLingUNetLatTransporterAgent_time
from cliport.agents.transporter_lang_goal import TwoStreamClipLingUNetLatTransporterAgent_net
names = {
         ################################
         ### CLIPort ###
         'cliport': TwoStreamClipLingUNetLatTransporterAgent,
         'cliport_two': TwoStreamClipLingUNetLatTransporterAgent_two,
         'cliport_time': TwoStreamClipLingUNetLatTransporterAgent_time,
         'cliport_net': TwoStreamClipLingUNetLatTransporterAgent_net,
