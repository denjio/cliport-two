...
class Task():
        ...
        def act(obs, info):  # pylint: disable=unused-argument
            ...
            if not replace:
                ...
                for i in range(len(objs)):
                    ...
                    # print('objecid', object_id, (symmetry, _) )
            ...
            # print('pose0', pick_pose, 'pose1', place_pose)
            # pose0(array([0.578125, -0.3, 0.04901123]), array([0, 0, 0, 1]))
            # pose1(array([0.36139959, 0.09918921, 0.07502157]), array([-0., 0., -0.83280414, 0.55356771]))
            return {'pose0': pick_pose, 'pose1': place_pose}
            # return {'pose0': (np.array([0, 0, 0]), np.array([0, 0, 0, 1])),
            #         'pose1': place_pose}
    ...
    def get_true_image(self, env):
        ...
        # print('camp', cmap.shape, hmap.shape, mask.shape)
        # plt.imshow(hmap)
        # plt.show()
